    ...
    <>
        ...
        <div className='container'>
            <div>
                ...
                Soak up captivating views of the Indian Ocean from our Premier Ocean Inter-Connecting rooms. Featuring one king bedroom connecting to a twin-bedded room; both Premier Ocean Inter-Connecting rooms offer contemporary décor and tasteful furnishings complement the state-of-the-art modern conveniences delivering a soothing city experience.                  </h4><br/><br/>          
                    <h2 className='h2 fw-bold textSm0'>
                        <i>
                            Features
                        </i>
