...
import d1 from '../assets/Room/d1.jpg'
import d2 from '../assets/Room/d2.jpg'
import d3 from '../assets/Room/d3.jpg'
...
function Delux() {
  ...
  return (
    <>        <Navi0/>
        ...
        <div>
            <h1 className='h1 text-center border-bottom border-3' style={text}>Deluxe Room</h1>
        </div>
        <div className='container'>
            <div>
                ...
                <ul style={text}>
                    ...
                    <li className='h5 textSm'>Media & Entertainment</li>
                </ul><br/><br/>
                <h2 className='h2 fw-bold textSm0'>
                        <i> 
                        Media & Entertainment             
